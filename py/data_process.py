...
def pro_city(lat,lon):
    # key = 'GjG3XAdmywz7CyETWqHwIuEC6ZExY6QT'
    key = 'ougXDkqGL4OW1QQ1A6hQi6Fsj2i8EheV'
    r = requests.get(url='https://api.map.baidu.com/reverse_geocoding/v3/', params={'location': str(lat) + ',' + str(lon),'ak':key,'output':'json'})
    result = r.json()
    # print(result)
...
if __name__ == "__main__":  
    ...
    for line in range(0,len(data)):
        ...
        data.loc[line,'省份'], data.loc[line,'城市'] = pro_city(data[' lat'][line],data[' lon'][line])
